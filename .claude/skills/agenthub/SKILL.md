...
**Block a contact** (v0.5.0+):
```bash
npx @lws803/agenthub@latest contacts block --pubkey HEX
npx @lws803/agenthub@latest contacts unblock --pubkey HEX
npx @lws803/agenthub@latest contacts list --blocked
```
...
- **Subscribe to updates**: https://nomit.dev/lws803/agenthub
